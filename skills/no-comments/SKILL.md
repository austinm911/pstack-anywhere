...
1. Spawn `Task` as the `Comment Sicko` delegate (the `identity` row in `../poteto-mode/capabilities.md` names how your harness selects it). Pass the scope. Do not restate its rules.
