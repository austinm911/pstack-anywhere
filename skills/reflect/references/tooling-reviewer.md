...
- `Read` tool calls against any `SKILL.md` file (the harness's workspace, user-level, or plugin-installed skill directories)
- delegate prompts that name a skill path
