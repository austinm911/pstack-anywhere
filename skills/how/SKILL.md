...
- the delegate identity your harness uses (see the `identity` row in `../poteto-mode/capabilities.md`)
- `model`: your configured how-explainer model (default: your strong judgment model)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults: one each on your strong judgment, strong instruction-following, and fast code models), all in a single message.
