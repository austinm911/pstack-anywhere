...
Before spawning investigators, list the available MCPs from your agent harness's environment. Use the available-tools map when present. Otherwise inspect the `mcps/` directory the harness exposes for enabled MCP servers.
