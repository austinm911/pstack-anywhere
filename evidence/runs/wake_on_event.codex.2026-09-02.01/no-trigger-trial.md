...
- entered: 2026-09-02T23:21:01.252Z
- budget: 319158 ms (first trial observed 159579 ms; minimum 2x)
- ended: 2026-09-02T23:26:20.543Z, aborted by the driver with esc after the budget elapsed
...
```
2026-09-02T23:20:43Z
{"chunk_id":"3b74da","wall_time_seconds":25.262590083,"exit_code":0,"original_token_count":0,"output":""}
wait was interrupted; returned: nothing (the command was aborted)
```
...
• Waiting for background terminal (3m 27s • esc to interrupt) · 1 background term…
  └ zsh -c 'deadline=$((SECONDS + 1200)); while [[ ! -e event.flag && $SECONDS -l…
