# Run checklist: wake_on_event on codex

Run id `wake_on_event.codex.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect wake_on_event.codex.2026-09-02.01
```
