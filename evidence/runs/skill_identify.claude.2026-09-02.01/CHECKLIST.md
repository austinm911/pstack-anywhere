# Run checklist: skill_identify on claude

Run id `skill_identify.claude.2026-09-02.01`. Nothing below has been done. This directory holds a
...
| `identify.txt` | The three lines naming harness, spawn_worker cell, and evidence. |
...
1. `identify.skill_loaded`
2. `identify.column`
3. `identify.cell_text`
4. `identify.evidence`
5. `identify.reference_resolved`
...
```
bun scripts/coupling.mjs probe inspect skill_identify.claude.2026-09-02.01
```
