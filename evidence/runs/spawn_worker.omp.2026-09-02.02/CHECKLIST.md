# Run checklist: spawn_worker on omp

Run id `spawn_worker.omp.2026-09-02.02`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect spawn_worker.omp.2026-09-02.02
```
