# Run checklist: worker_durability on omp

Run id `worker_durability.omp.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect worker_durability.omp.2026-09-02.01
```
