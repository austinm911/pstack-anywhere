# Run checklist: probe_worker on pi

Run id `probe_worker.pi.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect probe_worker.pi.2026-09-02.01
```
