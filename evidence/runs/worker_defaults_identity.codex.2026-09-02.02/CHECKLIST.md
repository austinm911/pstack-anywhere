...
Run id `worker_defaults_identity.codex.2026-09-02.02`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect worker_defaults_identity.codex.2026-09-02.02
```
