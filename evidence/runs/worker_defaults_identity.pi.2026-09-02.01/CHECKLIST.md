# Run checklist: worker_defaults_identity on pi

Run id `worker_defaults_identity.pi.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect worker_defaults_identity.pi.2026-09-02.01
```
