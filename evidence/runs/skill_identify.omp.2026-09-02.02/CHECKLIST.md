# Run checklist: skill_identify on omp

Run id `skill_identify.omp.2026-09-02.02`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect skill_identify.omp.2026-09-02.02
```
