...
Run id `skill_identify.codex.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect skill_identify.codex.2026-09-02.01
```
