# Run checklist: worker_defaults_readonly on omp

Run id `worker_defaults_readonly.omp.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect worker_defaults_readonly.omp.2026-09-02.01
```
