# Run checklist: worker_durability on codex

Run id `worker_durability.codex.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect worker_durability.codex.2026-09-02.01
```
