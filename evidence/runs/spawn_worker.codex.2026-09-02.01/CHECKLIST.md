# Run checklist: spawn_worker on codex

Run id `spawn_worker.codex.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect spawn_worker.codex.2026-09-02.01
```
