# Run checklist: human_question on omp

Run id `human_question.omp.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect human_question.omp.2026-09-02.01
```
