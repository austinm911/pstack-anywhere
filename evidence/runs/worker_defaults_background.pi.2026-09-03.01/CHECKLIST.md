# Run checklist: worker_defaults_background on pi

Run id `worker_defaults_background.pi.2026-09-03.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect worker_defaults_background.pi.2026-09-03.01
```
