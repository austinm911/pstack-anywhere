# Run checklist: probe_worker on omp

Run id `probe_worker.omp.2026-09-02.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect probe_worker.omp.2026-09-02.01
```
