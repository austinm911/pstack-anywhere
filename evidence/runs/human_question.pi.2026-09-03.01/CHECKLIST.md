# Run checklist: human_question on pi

Run id `human_question.pi.2026-09-03.01`. Nothing below has been done. This directory holds a
...
```
bun scripts/coupling.mjs probe inspect human_question.pi.2026-09-03.01
```
